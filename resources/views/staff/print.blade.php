        ...
        <div class="flex-wrapper-container">
            ...
            <div class="printable-meta-data">
                ...
                <div class="left-side-metadata">
                    ...
                    <h3>Invoice Date: <strong>{{ \Carbon\Carbon::parse($product->created_at)->format('Y-m-d') }}</strong></h3><br>
                ...
                <table class="printable-tr-table" style="width:100%; border-collapse:collapse; border:1px solid #000;">
                    ...
                    <tr style="font-weight: bold;">
                        ...
                        <td style="border:1px solid #000; padding:8px;">{{ number_format($totalQuantity, 2) }}</td>
                        <td></td>
                        <td style="border:1px solid #000; padding:8px;">{{ number_format($totalPrice, 2) }}</td>
                    </tr>
                </table>
                <br>
